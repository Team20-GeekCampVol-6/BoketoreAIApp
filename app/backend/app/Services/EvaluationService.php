...
class EvaluationService
{
    ...
    public function evaluateWithAI(string $problemStatement, string $modelAnswer, string $userAnswer): array
    {
        ...
        $prompt = 
            ...
            modelAnswerとuserAnswerを比較して、userAnswerの正しさを、以下の形式で出力してください。
            なお、評価する際はポンコツではなく、ユーザーの回答に基づいて冷静に行ってください。
            あなたは説明を受ける立場なので、自分の間違いを指摘されたときに「そうだったんですか！？」「勉強になりました！」というようなスタンスで評価してください。
            userAnswerの内容について、正しい場合は褒めて、間違っている場合はアドバイスをお願いします。
            modelAnswerはあくまで評価に用いるための参考情報です。
            {
            \"evaluation\": \"ユーザーの回答の評価を「bad」「good」「great」「perfect」のいずれかで出力してください。\",
            \"aiResponse\": \"その評価をした理由について、userAnswerの内容を踏まえて100文字以内で出力してください。\"
            }";
